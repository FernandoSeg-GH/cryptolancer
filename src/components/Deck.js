...
import slide_01 from '../assets/Slider/slider-02.jpeg'
import slide_02 from '../assets/Slider/dwoorks-bg-2.png'
import slide_03 from '../assets/Slider/dwoorks-bg-3.png'
...
class Deck extends Component {
    constructor(props) {
        ...
        this.state = {
            cards: [
                <Card picsum={slide_01} id="four" key="four" />,
                <Card picsum={slide_02} id="two" key="two" />,
                <Card picsum={slide_03} id="three" key="three" />,
                <Card picsum={slide_04} id="one" key="one" />,
            ]
        }
    }
    ...
    componentDidMount() {
        ...
        this.autoplay_interval_id = true;
        /* *********************************** */
    ...
    update_selection = () => {
        for (let i = 0; i < this.images.children.length; i++) {
            if (i === this.current_card) {
                this.selection_buttons_container.children[i].style.backgroundColor = '#FFFFFF';
                this.selection_buttons_container.children[i].style.width = '8px';
                this.selection_buttons_container.children[i].style.height = '8px';
    ...
    start_autoplay = () => {
        ...
        this.autoplay_timeout_id = setTimeout(() => {
            this.autoplay_interval_id = setInterval(() => {
                for (let i = 0; i < this.images.children.length; i++) {
                    this.images.children[i].style.transitionDuration = '1.0s';
...
const Loader = styled.div`
    ...
    width: 93%;
    height: 1px;
    background: linear-gradient(#FFFFFF 0 0), rgba(255, 255, 255, 0.5);
